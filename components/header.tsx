...
const Header = () => {
  ...
  useEffect(() => {
    // This would come from your cart context/provider
          ...
          >
            ...
            <div className="flex gap-2 mb-5">
              <Link
                ...
                onClick={() => setMobileOpen(false)}
              >
                <button className="lta-btn-login w-full">Login</button>
              </Link>
              <Link
                href="/register"
                className="flex-1"
                onClick={() => setMobileOpen(false)}
              >
                <button className="lta-btn-signup w-full">Sign Up</button>
              </Link>
            </div>
